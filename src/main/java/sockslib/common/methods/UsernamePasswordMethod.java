...
public class UsernamePasswordMethod extends AbstractSocksMethod {
    ...
    private static final String TAG = "UsernamePasswordMethod";
    ...
    public void doMethod(SocksProxy socksProxy) throws SocksException, IOException {
         ...
         * +----+------+----------+------+----------+ The VER field contains the current version
         * of the
         * subnegotiation, which is X’01’. The ULEN field contains the length of the UNAME field
         * that
         * follows. The UNAME field contains the username as known to the source operating system
         * . The
         * PLEN field contains the length of the PASSWD field that follows. The PASSWD field
         * contains
        ...
        // logger
        Log.d(TAG, LogMessageBuilder.build(authenticationResult, MsgType.RECEIVE));
    ...
    public void doMethod(Session session) throws SocksException, IOException {
        ...
        Log.d(TAG, String.format("SESSION[%d] Receive credentials: %s", session.getId(),
