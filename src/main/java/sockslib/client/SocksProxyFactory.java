...
public class SocksProxyFactory {
     ...
     */
    public static SocksProxy parse(String value)
        ...
        try {
            switch (values.length) {
                ...
                case 6:
                    ...
                    username = values[2];
                    password = values[3];
                    trustKeyStoreInfo = new KeyStoreInfo(PathUtil.getAbstractPath(values[4]),
                            values[5]);
                ...
                default:
                    throw new IllegalArgumentException(
                            "The input string should be formatted as [HOST],"
