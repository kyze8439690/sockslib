...
public interface SocksProxy {
     ...
     * do authentication. If SOCKS server select 0xFF,It means that none of the methods listed by
     * the
    ...
    /**
     * This method will send a CONNECT command to SOCKS server and ask SOCKS server to connect
     * remote
     * server.
     *
    ...
    /**
     * This method will send a UDP ASSOCIATE command to SOCKS server and ask SOCKS server to
     * establish
     * a relay server.
     *
     ...
     * @throws IOException    If any I/O error occurs.
     */
    CommandReplyMessage requestUdpAssociate(String host, int port)
    ...
    /**
     * Copy the {@link SocksProxy}. It will copy all properties of the {@link SocksProxy} but
     * without
     * chain proxy.
     *
